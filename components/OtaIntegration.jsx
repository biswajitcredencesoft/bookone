...
const IntegrationCard = ({ title, logos }) => {
  ...
  return (
    <div
      ref={ref}
      className={`bg-white rounded-2xl p-5 sm:p-6 flex flex-col justify-between min-h-[190px] transition-all duration-700 ease-out shadow-md hover:shadow-lg
      transform ${
        isVisible
          ...
          >
            ...
            <div className="text-gray-700 text-sm sm:text-base">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-1">
                ...
                <button
                  title="Explore more"
                  className="group inline-flex items-center justify-center w-8 h-8 bg-[#146683] text-white rounded-full transition-transform transform hover:scale-110"
                >
                  <FaArrowRight className="text-xs -rotate-45 group-hover:translate-x-0.5 transition-all" />
                </button>
              </div>
            </div>
          </div>
